...
func (gui *Gui) GetInitialKeybindings() []*Binding {
	bindings := []*Binding{
		...
		},
		{
			...
			Key:      '[',
			Modifier: gocui.ModNone,
			Handler:  wrappedHandler(gui.Requests.HandleNextResTab),
		},
		{
			ViewName: "response",
			Key:      ']',
			Modifier: gocui.ModNone,
			Handler:  wrappedHandler(gui.Requests.HandlePrevResTab),
		},
		{
			ViewName: "params",
			Key:      '[',
			Modifier: gocui.ModNone,
			Handler:  wrappedHandler(gui.Requests.HandlePrevReqTab),
		},
		{
			ViewName: "params",
			Key:      ']',
			Modifier: gocui.ModNone,
			Handler:  wrappedHandler(gui.Requests.HandleNextReqTab),
		},
		{
			ViewName: "params",
			Key:      gocui.KeyEnter,
